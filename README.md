...
Rather than trying to solve every aspect of the game at once, we want to build a focused prototype that can handle a smaller set of meaningful in-game situations. This makes it easier to:

* simplify the environment
* define useful state representations
* evaluate the quality of recommendations
* build a working end-to-end pipeline
...
Depending on feasibility, some of these may come from structured demo data, while others may come from visual processing.
